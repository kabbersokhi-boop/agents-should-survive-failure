...
the registered agent configuration, validates inputs and outputs, records attempts, pins the tool
definition version, and enforces email approval before execution.
